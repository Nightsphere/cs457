...
ServerSocket::ServerSocket(ushort portNumber): address(""), port(portNumber) {
    init(); 
    setSocketOptions();
} 


ServerSocket::ServerSocket(string networkAddress, ushort portNumber): address(networkAddress), port(portNumber) {
    init(); 
    setSocketOptions();
}
